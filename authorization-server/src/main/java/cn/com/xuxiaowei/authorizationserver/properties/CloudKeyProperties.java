...
public class CloudKeyProperties {
     ...
     */
    private CloudKeyProperties.KeyStore keyStore = new CloudKeyProperties.KeyStore();
    ...
    public CloudKeyProperties.KeyStore getKeyStore() {
        return this.keyStore;
    }

    public void setKeyStore(CloudKeyProperties.KeyStore keyStore) {
